...
class DQNAgent:
    def __init__(
        ...
        self.optimiser = torch.optim.RMSprop(self.policy_network.parameters(), lr=self.lr) #Need to use Adam optimiser (Benji said so)
    ...
    def optimise_td_loss(self):
        ...
        loss = torch.nn.functional.MSELoss(q_values, final_q)
